 ...
 */
router.get('/daily-log/:id', loadAccessibleProjects, (req, res, next) => {
 ...
 */
router.get('/daily-log/:id/preview', loadAccessibleProjects, (req, res, next) => {
 ...
 */
router.post('/bulk-export', loadAccessibleProjects, (req, res, next) => {
 ...
 */
router.get('/bulk-export/project/:projectId', loadAccessibleProjects, (req, res, next) => {
