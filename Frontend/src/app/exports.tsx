    ...
    <View className="flex-1 bg-gray-50 dark:bg-gray-900">
      ...
      <ScrollView className="flex-1 px-4 pt-4" contentContainerStyle={{ paddingBottom: 40 }}>
        ...
        <ExportButton
          ...
          icon={<Calendar size={24} color="#1F5C1A" />}
        ...
        <ExportButton
          ...
          icon={<Building2 size={24} color="#1F5C1A" />}
        ...
        <ExportButton
          ...
          icon={<Database size={24} color="#1F5C1A" />}
        ...
        <ExportButton
          ...
          icon={<FileAudio size={24} color="#1F5C1A" />}
