...
export default {
  ...
  forms: {
    ...
    selectProject: 'Select a project to use forms',
    fields: 'fields',
    progress: 'Progress',
    ...
    completeRequired: 'Please fill in all required fields before submitting.',
    submitConfirm: 'Are you sure you want to submit this form? You will not be able to edit it after submission.',
    completeRequiredHint: 'Complete all required fields to submit',
    tapToSign: 'Tap to sign as',
  ...
  voiceLists: {
    title: 'Voice Lists',
    newList: 'New Voice List',
    createList: 'Create List',
    noLists: 'No voice lists yet',
    createFirst: 'Create your first voice list',
    listName: 'List Name',
    listType: 'List Type',
    ...
    recording: 'Recording...',
    processing: 'Processing...',
    tapToRecord: 'Tap to start recording your list',
