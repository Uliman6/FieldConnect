...
export function TasksSection({ tasks, onAdd, onUpdate, onRemove, totalWorkers, totalHours, onAudioRecorded, currentLogId }: TasksSectionProps) {
  ...
  return (
    <View>
      ...
      <View className="flex-row">
        <View className="flex-1 mr-2">
          <Button title="Add Company" onPress={handleAdd} variant="secondary" icon={<Plus size={20} color="#F97316" />} />
        </View>
...
export function VisitorsSection({ visitors, onAdd, onUpdate, onRemove, onAudioRecorded }: VisitorsSectionProps) {
  ...
  return (
    <View>
      ...
      <Button title="Add Visitor" onPress={handleAdd} variant="secondary" size="sm" icon={<Plus size={18} color="#F97316" />} />
    </View>
  );
}
...
export function EquipmentSection({ equipment, onAdd, onUpdate, onRemove, onAudioRecorded }: EquipmentSectionProps) {
  ...
  return (
    <View>
      ...
      <Button title="Add Equipment" onPress={handleAdd} variant="secondary" size="sm" icon={<Plus size={18} color="#F97316" />} />
    </View>
  );
}
...
export function MaterialsSection({ materials, onAdd, onUpdate, onRemove, onAudioRecorded }: MaterialsSectionProps) {
  ...
  return (
    <View>
      ...
      <Button title="Add Material" onPress={handleAdd} variant="secondary" size="sm" icon={<Plus size={18} color="#F97316" />} />
    </View>
  );
}
