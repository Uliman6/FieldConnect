...
export default function DailyLogContent() {
  ...
  const handlePrevDay = useCallback(() => {
    ...
    if (existingLog) {
      ...
      useDailyLogStore.getState().updateDailyLog(newLog.id, { date: newDate });
    }
  }, [log, dailyLogs, setCurrentLog, createDailyLog]);
  ...
  return (
    ...
    >
      {/* Header */}
      <View className="bg-white dark:bg-gray-800 px-4 pb-4 pt-3">
